...
func createObjects(ctx context.Context) (err error) {
	if err = createResetRedFishMountpointObject(ctx); err != nil {
		return
	}

	if err = createResetFunctionObject(ctx); err != nil {
		return
	}
...
func createResetRedFishMountpointObject(ctx context.Context) (err error) {
